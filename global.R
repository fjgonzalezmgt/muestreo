...
i18n <- list(
  es = list(
    ...
    download_plan_csv = "Descargar plan (Excel)",
    ...
    input_parameters_section = "Parametros de entrada",
    plan_results_section = "Resultados del plan",
    sample_section_prefix = "Muestra",
    oc_curve = "Curva OC",
    asn_curve = "Curva ASN",
    ...
    sample_plan_variables_file = "plan_muestreo_variables",
    sample_plan_attributes_file = "plan_muestreo_atributos_",
    workbook_sheet_inputs = "Parametros",
    workbook_sheet_results = "Resultados",
  ...
  en = list(
    ...
    download_plan_csv = "Download plan (Excel)",
    ...
    input_parameters_section = "Input parameters",
    plan_results_section = "Plan results",
    sample_section_prefix = "Sample",
    oc_curve = "OC Curve",
    asn_curve = "ASN Curve",
    nonconforming_prop = "Nonconforming proportion",
    acceptance_prob = "Acceptance probability",
    average_sample_size = "Average sample size",
    sample_plan_variables_file = "sampling_plan_variables",
    sample_plan_attributes_file = "sampling_plan_attributes_",
    workbook_sheet_inputs = "Inputs",
    workbook_sheet_results = "Results",
